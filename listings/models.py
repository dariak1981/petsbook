...
class Listing(models.Model):
    ...
    photo_main = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True, verbose_name = _('main photo'),)
    photo_1 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True, verbose_name= _('photo_1'),)
    photo_2 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True, verbose_name= _('photo_2'),)
    photo_3 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True, verbose_name= _('photo_3'),)
    photo_4 = models.ImageField(upload_to='photos/%Y/%m/%d/', blank=True, null=True, verbose_name= _('photo_4'),)
